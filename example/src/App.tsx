...
export default function App() {
  ...
  const keyExchangeWithServer = async () => {
    ...
    try {
      var data = decimalToHexa(clientKeys.clientPublicKey) + '';
      var config = {
        method: 'post',
        url: 'https://phoenix.integrate.singlife.com/v11/sso-service/dh/keyExchangeV2',
        headers: {
          'x-api-key': '5c80c3498f4d613eccb5952c0b607d78eb414f109fbfd44cdd179096',
          'p': '',
          'g': '',
  ...
  //     return Aes.encrypt(text, key, '00000000000000000000000000000000', 'aes-256-cbc').then(cipher => ({
  //       cipher,
  //     }))
  //   })
  // }
  const encryptData = async (text, key) => {
    const response = await Aes.encrypt(text, key, '00000000000000000000000000000000', 'aes-256-cbc');
    return response;
  }
  ...
  return (
    <SafeAreaView >
      <View style={{ flex: 1, marginTop: 40, alignItems: 'center' }}>
        ...
        <Text style={{ color: 'black', padding: 20 }}>Client Pub Keys: {clientKeys?.clientPublicKey}</Text>
        ...
        <Text style={{ color: 'black', padding: 20 }}>Server Pub Keys: {serverPubKey}</Text>
...
//     //For IOS only 
//     const { clientPrivateKey, clientPublicKey } = await DhKeys.getEncodedPublicKeyFromPg(PG.p, PG.g);
//     const sharedKey = await DhKeys.getSharedSecretHex(serverPublicKeyIOS, clientPrivateKey, PG.p);
//     setClientScecretKey(sharedKey);
//   }
